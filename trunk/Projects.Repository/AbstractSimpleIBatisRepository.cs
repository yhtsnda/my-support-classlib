...
{
    /// <summary>
    /// 基于IBatis的简单仓储接口的抽象实现
    /// </summary>
    /// <typeparam name="TEntity">实体对象</typeparam>
    /// <typeparam name="TSearch">查询对象</typeparam>
    public abstract class AbstractSimpleIBatisRepository<TEntity, TSearch> : 
        ISimpleRepository<TEntity, TSearch>
        where TEntity : class
        where TSearch : class
    {
        public readonly string MappingKey = "default";
