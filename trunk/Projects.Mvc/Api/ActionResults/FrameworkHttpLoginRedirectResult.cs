...
{
    public class FrameworkHttpLoginRedirectResult : HttpStatusCodeResult
    {
        ...
        public FrameworkHttpLoginRedirectResult(string returnUrl, string statusDescription, 
        ...
        public FrameworkHttpLoginRedirectResult(string returnUrl, string loginUrl = "", string returnUrlParamName=null):
            this(returnUrl,null,loginUrl,returnUrlParamName)
        {
            
        }

        public FrameworkHttpLoginRedirectResult()
