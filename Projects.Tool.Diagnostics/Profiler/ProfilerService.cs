...
namespace Projects.Tool.Diagnostics
{
    ...
    {
        static ProfilerHttpCommand commandService;
        ...
        {
            commandService = new ProfilerHttpCommand();
        ...
        internal static void Init()
        {
            ...
            if (node != null)
            {
                ...
                IProfilerSerializer profilerSerializer = 
                    (IProfilerSerializer)Projects.Tool.Reflection.FastActivator.Create(type);
        ...
        public static HttpCommand CommandService { get { return commandService; } }
