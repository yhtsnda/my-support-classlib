...
namespace Projects.Framework
{
    public static class DependCacheDomain
    {
        ...
        {
            return new DependCacheDomain<TEntity>(missingItemHandler, cacheName, cacheKeyFormat, secondesToLive, contextCacheEnabled);
        }
        ...
        public static DependCacheDomain<TEntity, TParam1, TParam2, TKey> CreateTripletKey<TEntity, TParam1, TParam2, TKey>(Func<TEntity, TKey> entityKeySelector, Func<TParam1, TParam2, TKey, TEntity> missingItemHandler, Func<TParam1, TParam2, IEnumerable<TKey>, IEnumerable<TEntity>> missingItemsHandler, string cacheName = null, string cacheKeyFormat = null, int secondesToLive = 0, bool contextCacheEnabled = true)
          where TEntity : IQueryTimestamp
        {
            return new DependCacheDomain<TEntity, TParam1, TParam2, TKey>(entityKeySelector, missingItemHandler, missingItemsHandler, cacheName, cacheKeyFormat, secondesToLive, contextCacheEnabled);
        }
    }
}
